...
# Eig2
eig2_supp <- unique(data.frame(rbindlist(lapply(rownames(overlapping_outliers[[2]][overlapping_outliers[[2]]$n.overlaps == 4,]),function(window_id){
...
eig2_supp <- eig2_supp[,c("window_id","eigenvector","eigenvalue","total_variance","parallel_lineages","parallel_pops","antiparallel_pops","window_size_snps")]
